        ...
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                ...
                <li><a href="index.php?halaman=kategori"><i class="fa fa-list fa-3x"></i>Kategori</a></li>
                <li><a href="index.php?halaman=produk"><i class="fa fa-shopping-cart fa-3x"></i>Produk</a></li>
                <li><a href="index.php?halaman=pembelian"><i class="fa fa-dollar fa-3x"></i>Pembelian</a></li>
                <li><a href="index.php?halaman=laporan"><i class="fa fa-file fa-3x"></i>Laporan</a></li>
